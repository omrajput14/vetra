...
/**
 * Regression and integration test suite for Veterinarian Authentication, Role Mapping, and Dashboard Telemetry.
 */
@SpringBootTest
@ActiveProfiles("test")
@Transactional
...
class VetAuthIntegrationTest {
  ...
  void testVetRegistrationAndLoginFlow() {
    VetRegisterRequest regReq = new VetRegisterRequest(
        "dr.jenkins@vetra.app", "+1555019999", "vetpass123", "Dr. Sarah Jenkins",
        "VET-9941-XX", "BVSc & AH", "Large Animals", "Valley Veterinary Clinic", 10, 12.0, 77.0);
