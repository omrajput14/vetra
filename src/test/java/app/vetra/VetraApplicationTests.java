 ...
 *
 * <p>Verifies that the entire application context starts without errors using the {@code test}
 * profile with an in-memory / disabled datasource so no running PostgreSQL is required.
 */
@SpringBootTest
@ActiveProfiles("test")
@TestPropertySource(properties = {
    "spring.datasource.url=jdbc:h2:mem:vetra_test;DB_CLOSE_DELAY=-1;MODE=PostgreSQL",
...
class VetraApplicationTests {

  /**
   * Verifies that the Spring application context loads without any errors.
   * This is the foundational infrastructure smoke test.
   */
  @Test
  void contextLoads() {
