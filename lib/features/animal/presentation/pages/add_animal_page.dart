  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text(l10n?.addAnimal ?? 'Register New Animal', style: AppTypography.screenTitle),
        leading: IconButton(
        ...
        child: ListView(
          ...
          children: [
            ...
            AppTextField(
              ...
              labelText: '${l10n?.qrPassport ?? "QR Code Identifier"} (Optional)',
            ...
            AppTextField(
              ...
              labelText: '${l10n?.breed ?? "Breed"} (Optional)',
